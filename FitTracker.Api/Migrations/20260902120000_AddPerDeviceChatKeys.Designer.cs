...
namespace FitTracker.Api.Migrations
{
    ...
    [Migration("20260902120000_AddPerDeviceChatKeys")]
    partial class AddPerDeviceChatKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitTracker.Api.Models.ChatMessage", b =>
                {
                    ...
                    b.Property<string>("EphemeralPublicKeyJwk")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FitTracker.Api.Models.ChatMessageKey", b =>
                {
            ...
            modelBuilder.Entity("FitTracker.Api.Models.UserChatDeviceKey", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FitTracker.Api.Models.ChatMessageKey", b =>
                {
                    b.HasOne("FitTracker.Api.Models.ChatMessage", "ChatMessage")
                        .WithMany("Keys")
